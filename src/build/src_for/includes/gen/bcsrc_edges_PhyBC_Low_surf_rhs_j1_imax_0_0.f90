...
rhs(nx+2+0,1-2+0,indvars(1)) =   -  ( (qst(nx+2+0,1-2+0,indvarsst(10))*(d1_rhs_rho_dx_0_nxp2p01m2p0k))*qst(nx+2+0,1-2+0,indvarsst(5))+&
                    (q(nx+2+0,1-2+0,indvars(1))*(d1_rhs_rho_dy_0_nxp2p01m2p0k)*qst(nx+2+0,1-2+0,indvarsst(11)))*qst(nx+2+0,1-2+0,indvarsst(12)) ) 
...
d1_rhs_u_dx_0_nxp2p0p01m2p0k = -4.0_wp/3.0_wp*((1+&
                    ...
                    param_float(21 + 5))*((q(nx+2+0+0,1-2+0,indvars(4))-&
                    0.5_wp*(q(nx+2+0+0,1-2+0,indvars(2))*q(nx+2+0+0,1-2+0,indvars(2))+&
                    q(nx+2+0+0,1-2+0,indvars(3))*q(nx+2+0+0,1-2+0,indvars(3)))))/param_float(4 + 5)**1.5)*param_float(1 + 5)*(d2_rhs_u_dxdx_0_0_nxp2p0p01m2p0k)*qst(nx+2+0+0,1-2+0,indvarsst(10))
...
d1_rhs_u_dx_0_nxp2p0m11m2p0k = -4.0_wp/3.0_wp*((1+&
                    ...
                    param_float(21 + 5))*((q(nx+2+0-1,1-2+0,indvars(4))-&
                    0.5_wp*(q(nx+2+0-1,1-2+0,indvars(2))*q(nx+2+0-1,1-2+0,indvars(2))+&
                    q(nx+2+0-1,1-2+0,indvars(3))*q(nx+2+0-1,1-2+0,indvars(3)))))/param_float(4 + 5)**1.5)*param_float(1 + 5)*(d2_rhs_u_dxdx_0_0_nxp2p0m11m2p0k)*qst(nx+2+0-1,1-2+0,indvarsst(10))
...
d1_rhs_u_dx_0_nxp2p0m21m2p0k = -4.0_wp/3.0_wp*((1+&
                    ...
                    param_float(21 + 5))*((q(nx+2+0-2,1-2+0,indvars(4))-&
                    0.5_wp*(q(nx+2+0-2,1-2+0,indvars(2))*q(nx+2+0-2,1-2+0,indvars(2))+&
                    q(nx+2+0-2,1-2+0,indvars(3))*q(nx+2+0-2,1-2+0,indvars(3)))))/param_float(4 + 5)**1.5)*param_float(1 + 5)*(d2_rhs_u_dxdx_0_0_nxp2p0m21m2p0k)*qst(nx+2+0-2,1-2+0,indvarsst(10))
...
d1_rhs_v_dx_0_nxp2p0p01m2p0k = -((1+&
                    ...
                    param_float(21 + 5))*((q(nx+2+0+0,1-2+0,indvars(4))-&
                    0.5_wp*(q(nx+2+0+0,1-2+0,indvars(2))*q(nx+2+0+0,1-2+0,indvars(2))+&
                    q(nx+2+0+0,1-2+0,indvars(3))*q(nx+2+0+0,1-2+0,indvars(3)))))/param_float(4 + 5)**1.5)*param_float(1 + 5)*(d2_rhs_v_dxdx_0_0_nxp2p0p01m2p0k)*qst(nx+2+0+0,1-2+0,indvarsst(10))
...
d1_rhs_v_dx_0_nxp2p0m11m2p0k = -((1+&
                    ...
                    param_float(21 + 5))*((q(nx+2+0-1,1-2+0,indvars(4))-&
                    0.5_wp*(q(nx+2+0-1,1-2+0,indvars(2))*q(nx+2+0-1,1-2+0,indvars(2))+&
                    q(nx+2+0-1,1-2+0,indvars(3))*q(nx+2+0-1,1-2+0,indvars(3)))))/param_float(4 + 5)**1.5)*param_float(1 + 5)*(d2_rhs_v_dxdx_0_0_nxp2p0m11m2p0k)*qst(nx+2+0-1,1-2+0,indvarsst(10))
...
d1_rhs_v_dx_0_nxp2p0m21m2p0k = -((1+&
                    ...
                    param_float(21 + 5))*((q(nx+2+0-2,1-2+0,indvars(4))-&
                    0.5_wp*(q(nx+2+0-2,1-2+0,indvars(2))*q(nx+2+0-2,1-2+0,indvars(2))+&
                    q(nx+2+0-2,1-2+0,indvars(3))*q(nx+2+0-2,1-2+0,indvars(3)))))/param_float(4 + 5)**1.5)*param_float(1 + 5)*(d2_rhs_v_dxdx_0_0_nxp2p0m21m2p0k)*qst(nx+2+0-2,1-2+0,indvarsst(10))
...
d1_rhs_et_dx_0_nxp2p0p01m2p0k = -4.0_wp/3.0_wp*((1+&
                    ...
                    param_float(21 + 5))*((q(nx+2+0+0,1-2+0,indvars(4))-&
                    0.5_wp*(q(nx+2+0+0,1-2+0,indvars(2))*q(nx+2+0+0,1-2+0,indvars(2))+&
                    q(nx+2+0+0,1-2+0,indvars(3))*q(nx+2+0+0,1-2+0,indvars(3)))))/param_float(4 + 5)**1.5)*param_float(1 + 5)*(d2_rhs_u_dxdx_0_0_nxp2p0p01m2p0k)*qst(nx+2+0+0,1-2+0,indvarsst(10))*q(nx+2+0+0,1-2+0,indvars(2))-&
                    ((1+&
                    param_float(21 + 5))/(((q(nx+2+0+0,1-2+0,indvars(4))-&
                    0.5_wp*(q(nx+2+0+0,1-2+0,indvars(2))*q(nx+2+0+0,1-2+0,indvars(2))+&
                    q(nx+2+0+0,1-2+0,indvars(3))*q(nx+2+0+0,1-2+0,indvars(3)))))/param_float(4 + 5)+&
                    param_float(21 + 5))*((q(nx+2+0+0,1-2+0,indvars(4))-&
                    0.5_wp*(q(nx+2+0+0,1-2+0,indvars(2))*q(nx+2+0+0,1-2+0,indvars(2))+&
                    q(nx+2+0+0,1-2+0,indvars(3))*q(nx+2+0+0,1-2+0,indvars(3)))))/param_float(4 + 5)**1.5)*param_float(1 + 5)*(d2_rhs_v_dxdx_0_0_nxp2p0p01m2p0k)*qst(nx+2+0+0,1-2+0,indvarsst(10))*q(nx+2+0+0,1-2+0,indvars(3))-&
...
d1_rhs_et_dx_0_nxp2p0m11m2p0k = -4.0_wp/3.0_wp*((1+&
                    ...
                    param_float(21 + 5))*((q(nx+2+0-1,1-2+0,indvars(4))-&
                    0.5_wp*(q(nx+2+0-1,1-2+0,indvars(2))*q(nx+2+0-1,1-2+0,indvars(2))+&
                    q(nx+2+0-1,1-2+0,indvars(3))*q(nx+2+0-1,1-2+0,indvars(3)))))/param_float(4 + 5)**1.5)*param_float(1 + 5)*(d2_rhs_u_dxdx_0_0_nxp2p0m11m2p0k)*qst(nx+2+0-1,1-2+0,indvarsst(10))*q(nx+2+0-1,1-2+0,indvars(2))-&
                    ((1+&
                    param_float(21 + 5))/(((q(nx+2+0-1,1-2+0,indvars(4))-&
                    0.5_wp*(q(nx+2+0-1,1-2+0,indvars(2))*q(nx+2+0-1,1-2+0,indvars(2))+&
                    q(nx+2+0-1,1-2+0,indvars(3))*q(nx+2+0-1,1-2+0,indvars(3)))))/param_float(4 + 5)+&
                    param_float(21 + 5))*((q(nx+2+0-1,1-2+0,indvars(4))-&
                    0.5_wp*(q(nx+2+0-1,1-2+0,indvars(2))*q(nx+2+0-1,1-2+0,indvars(2))+&
                    q(nx+2+0-1,1-2+0,indvars(3))*q(nx+2+0-1,1-2+0,indvars(3)))))/param_float(4 + 5)**1.5)*param_float(1 + 5)*(d2_rhs_v_dxdx_0_0_nxp2p0m11m2p0k)*qst(nx+2+0-1,1-2+0,indvarsst(10))*q(nx+2+0-1,1-2+0,indvars(3))-&
...
d1_rhs_et_dx_0_nxp2p0m21m2p0k = -4.0_wp/3.0_wp*((1+&
                    ...
                    param_float(21 + 5))*((q(nx+2+0-2,1-2+0,indvars(4))-&
                    0.5_wp*(q(nx+2+0-2,1-2+0,indvars(2))*q(nx+2+0-2,1-2+0,indvars(2))+&
                    q(nx+2+0-2,1-2+0,indvars(3))*q(nx+2+0-2,1-2+0,indvars(3)))))/param_float(4 + 5)**1.5)*param_float(1 + 5)*(d2_rhs_u_dxdx_0_0_nxp2p0m21m2p0k)*qst(nx+2+0-2,1-2+0,indvarsst(10))*q(nx+2+0-2,1-2+0,indvars(2))-&
                    ((1+&
                    param_float(21 + 5))/(((q(nx+2+0-2,1-2+0,indvars(4))-&
                    0.5_wp*(q(nx+2+0-2,1-2+0,indvars(2))*q(nx+2+0-2,1-2+0,indvars(2))+&
                    q(nx+2+0-2,1-2+0,indvars(3))*q(nx+2+0-2,1-2+0,indvars(3)))))/param_float(4 + 5)+&
                    param_float(21 + 5))*((q(nx+2+0-2,1-2+0,indvars(4))-&
                    0.5_wp*(q(nx+2+0-2,1-2+0,indvars(2))*q(nx+2+0-2,1-2+0,indvars(2))+&
                    q(nx+2+0-2,1-2+0,indvars(3))*q(nx+2+0-2,1-2+0,indvars(3)))))/param_float(4 + 5)**1.5)*param_float(1 + 5)*(d2_rhs_v_dxdx_0_0_nxp2p0m21m2p0k)*qst(nx+2+0-2,1-2+0,indvarsst(10))*q(nx+2+0-2,1-2+0,indvars(3))-&
...
rhs(nx+2+0,1-2+0,indvars(4)) =   -  ( (qst(nx+2+0,1-2+0,indvarsst(10))*(d1_rhs_et_dx_0_nxp2p01m2p0k)+&
                    ...
                    param_float(21 + 5))*((q(nx+2+0,1-2+0,indvars(4))-&
                    0.5_wp*(q(nx+2+0,1-2+0,indvars(2))*q(nx+2+0,1-2+0,indvars(2))+&
                    q(nx+2+0,1-2+0,indvars(3))*q(nx+2+0,1-2+0,indvars(3)))))/param_float(4 + 5)**1.5)*param_float(1 + 5)*(d1_rhs_et_dy_0_nxp2p01m2p0k)*(d1_rhs_et_dy_0_nxp2p01m2p0k)*qst(nx+2+0,1-2+0,indvarsst(11))**2-&
                    4.0_wp/3.0_wp*((1+&
                    param_float(21 + 5))/(((q(nx+2+0,1-2+0,indvars(4))-&
                    0.5_wp*(q(nx+2+0,1-2+0,indvars(2))*q(nx+2+0,1-2+0,indvars(2))+&
                    q(nx+2+0,1-2+0,indvars(3))*q(nx+2+0,1-2+0,indvars(3)))))/param_float(4 + 5)+&
                    param_float(21 + 5))*((q(nx+2+0,1-2+0,indvars(4))-&
                    0.5_wp*(q(nx+2+0,1-2+0,indvars(2))*q(nx+2+0,1-2+0,indvars(2))+&
                    q(nx+2+0,1-2+0,indvars(3))*q(nx+2+0,1-2+0,indvars(3)))))/param_float(4 + 5)**1.5)*param_float(1 + 5)*(d1_rhs_rho_dy_0_nxp2p01m2p0k)*(d1_rhs_rho_dy_0_nxp2p01m2p0k)*qst(nx+2+0,1-2+0,indvarsst(11))**2-&
                    ...
                    0.5_wp*(q(nx+2+0,1-2+0,indvars(2))*q(nx+2+0,1-2+0,indvars(2))+&
                    q(nx+2+0,1-2+0,indvars(3))*q(nx+2+0,1-2+0,indvars(3))))))*(d1_rhs_rho_dy_0_nxp2p01m2p0k)*qst(nx+2+0,1-2+0,indvarsst(11)))*qst(nx+2+0,1-2+0,indvarsst(12)) ) 
